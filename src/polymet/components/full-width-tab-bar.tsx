...
interface FullWidthTabBarProps {
  activeTab?: string;
  onTabChange?: (tab: string) => void;
}

export default function FullWidthTabBar({
  activeTab: propActiveTab,
  onTabChange,
}: FullWidthTabBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full max-w-[485px] mx-auto bg-white/80 backdrop-blur-md border-t border-gray-100 flex items-center justify-around px-0 pt-2 pb-8 z-10 shadow-[0_-1px_0_rgba(0,0,0,0.05)]">
      {tabs.map((tab) => {
