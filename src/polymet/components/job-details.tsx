...
export default function JobDetails() {
  ...
  const handleOnMyWay = () => {
    ...
    const newMessage = {
      ...
      text: "I'm on my way to your location now. See you soon!",
      sender: "technician",
      timestamp: new Date(),
    };
  ...
  const handleIveArrived = () => {
    ...
    const newMessage = {
      id: Date.now().toString(),
      text: "I've arrived at your location and will begin service shortly.",
      sender: "technician",
      timestamp: new Date(),
    };
    ...
    <div className="flex flex-col h-full bg-white pb-6">
      ...
      <div className="px-4 mt-4 space-y-3">
        {!onMyWaySent ? (
          ...
          <Link to={`/jobs/${jobId}/checklist`} className="w-full block">
            <ActionButton
              label="Start Service"
              icon={<CheckIcon className="h-4 w-4" />}
              variant="primary"
