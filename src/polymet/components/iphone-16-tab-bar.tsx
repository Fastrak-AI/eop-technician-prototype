...
interface IPhone16TabBarProps {
  activeTab?: string;
  onTabChange?: (tab: string) => void;
}

export default function IPhone16TabBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full bg-white/80 backdrop-blur-md border-t border-gray-100 flex items-center justify-around px-6 pt-2 pb-8 z-10 shadow-[0_-1px_0_rgba(0,0,0,0.05)]">
      {tabs.map((tab) => {
